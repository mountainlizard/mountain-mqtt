...
//     sender: Writer<'a, NoopRawMutex, B>,
...
//             .write_all(&message)
//             .await
//             .expect("Failed to write to client pipe, this should be Infallible");
//     }
...
//         let mut tx_pipe: Pipe<NoopRawMutex, B> = Pipe::new();
...
//                 let n = tx_pipe_reader.read(&mut buf).await;
